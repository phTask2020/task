...
public final class SimpleGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.JPA.grpc.lib.HelloRequest,
      com.JPA.grpc.lib.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.JPA.grpc.lib.HelloRequest.class,
      responseType = com.JPA.grpc.lib.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.JPA.grpc.lib.HelloRequest,
      com.JPA.grpc.lib.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.JPA.grpc.lib.HelloRequest, com.JPA.grpc.lib.HelloReply> getSayHelloMethod;
      ...
      synchronized (SimpleGrpc.class) {
        if ((getSayHelloMethod = SimpleGrpc.getSayHelloMethod) == null) {
          SimpleGrpc.getSayHelloMethod = getSayHelloMethod = 
              io.grpc.MethodDescriptor.<com.JPA.grpc.lib.HelloRequest, com.JPA.grpc.lib.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "Simple", "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.JPA.grpc.lib.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.JPA.grpc.lib.HelloReply.getDefaultInstance()))
  ...
  public static abstract class SimpleImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(com.JPA.grpc.lib.HelloRequest request,
        io.grpc.stub.StreamObserver<com.JPA.grpc.lib.HelloReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.JPA.grpc.lib.HelloRequest,
                com.JPA.grpc.lib.HelloReply>(
  ...
  public static final class SimpleBlockingStub extends io.grpc.stub.AbstractStub<SimpleBlockingStub> {
    ...
    /**
     */
    public com.JPA.grpc.lib.HelloReply sayHello(com.JPA.grpc.lib.HelloRequest request) {
  ...
  public static final class SimpleFutureStub extends io.grpc.stub.AbstractStub<SimpleFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.JPA.grpc.lib.HelloReply> sayHello(
        com.JPA.grpc.lib.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.JPA.grpc.lib.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.JPA.grpc.lib.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class SimpleBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.JPA.grpc.lib.HelloProto.getDescriptor();
    }
